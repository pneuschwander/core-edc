...
public class Oauth2ServiceExtension implements ServiceExtension {
    ...
    @Setting(value = "Leeway in seconds for validating the issuedAt (iat) claim in the token. By default it is 0 seconds.", defaultValue = "0", type = "int")
    private static final String ISSUED_AT_LEEWAY = "edc.oauth.validation.iat.leeway";
